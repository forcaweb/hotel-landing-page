...
function openChatFormBooking() {
  ...
  formBooking.addEventListener("submit", (e) => {
    ...
    const numberWhatsapp = `https://wa.me/553591596756?text=Ol%C3%A1%2C%20estou%20vindo%20pelo%20site%20e%20gostaria%20de%20fazer%20uma%20reserva.%20Quero%20na%20Data%20${converteDate(checkin)}%20a%20${converteDate(checkout)}%20para%20${adultsQtds}%20adultos%20e%20${childrenQtds}%20crian%C3%A7as.`;
